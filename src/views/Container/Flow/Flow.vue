...
let getXml = () => {
    xml.value =
        ...
        "    </bpmn:startEvent>\n" +
        '    <bpmn:task id="Activity_03qvdye" name="测试">\n' +
        "      <bpmn:incoming>Flow_0ofkit1</bpmn:incoming>\n" +
        "      <bpmn:outgoing>Flow_0syynkn</bpmn:outgoing>\n" +
        "    </bpmn:task>\n" +
        '    <bpmn:sequenceFlow id="Flow_0ofkit1" sourceRef="StartEvent_1" targetRef="Activity_03qvdye" />\n' +
        '    <bpmn:endEvent id="Event_0eojx0h">\n' +
        "      <bpmn:incoming>Flow_0syynkn</bpmn:incoming>\n" +
        "    </bpmn:endEvent>\n" +
        '    <bpmn:sequenceFlow id="Flow_0syynkn" sourceRef="Activity_03qvdye" targetRef="Event_0eojx0h" />\n' +
        "  </bpmn:process>\n" +
        ...
        "      </bpmndi:BPMNShape>\n" +
        '      <bpmndi:BPMNShape id="Activity_03qvdye_di" bpmnElement="Activity_03qvdye">\n' +
